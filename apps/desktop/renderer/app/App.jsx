  ...
  return (
    <>
      <div className="px-5 py-3 border-b border-gray-200">
        ...
        <p className="text-xs text-gray-500">{current.name} · {current.role} · Phases 4-6 bring channels + realtime</p>
      </div>
      <div className="flex-1 overflow-y-auto px-5 py-6">
        <div className="max-w-2xl">
          ...
          <p className="text-sm text-gray-500 mb-4">This is the very beginning of your workspace.</p>
      ...
      <div className="flex-1 flex min-h-0">
        <aside className="w-60 shrink-0 bg-[#3F0E40] text-white flex flex-col min-h-0">
          ...
          <nav className="flex-1 overflow-y-auto px-2 py-3">
            <p className="px-3 pb-1 text-xs font-semibold text-white/50 uppercase tracking-wide">Workspace</p>
            <ul className="space-y-0.5 mb-4">
              <SidebarItem to="/"># general</SidebarItem>
