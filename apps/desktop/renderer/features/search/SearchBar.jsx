    ...
    <div className="relative w-full max-w-xl">
      <form onSubmit={submit}>
        <input
          ...
          placeholder="Search messages, files, channels, people  (Ctrl+K)"
      ...
      {open && recent.length > 0 && (
        <div className="absolute top-full mt-1 left-0 right-0 bg-white text-black rounded-lg shadow-xl py-1 z-30">
